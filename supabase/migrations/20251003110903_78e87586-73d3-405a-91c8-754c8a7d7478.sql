-- Drop ALL existing client RLS policies (including any partially created ones)
...
DROP POLICY IF EXISTS "Only account owners can insert clients" ON public.clients;
DROP POLICY IF EXISTS "Account owners and staff can update clients" ON public.clients;
DROP POLICY IF EXISTS "Only account owners can delete clients" ON public.clients;
